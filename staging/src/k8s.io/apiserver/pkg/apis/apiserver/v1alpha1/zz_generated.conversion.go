...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ControllerLeaderConfiguration)(nil), (*apiserver.ControllerLeaderConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ControllerLeaderConfiguration_To_apiserver_ControllerLeaderConfiguration(a.(*ControllerLeaderConfiguration), b.(*apiserver.ControllerLeaderConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*apiserver.ControllerLeaderConfiguration)(nil), (*ControllerLeaderConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_apiserver_ControllerLeaderConfiguration_To_v1alpha1_ControllerLeaderConfiguration(a.(*apiserver.ControllerLeaderConfiguration), b.(*ControllerLeaderConfiguration), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*LeaderMigratorConfiguration)(nil), (*apiserver.LeaderMigratorConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_LeaderMigratorConfiguration_To_apiserver_LeaderMigratorConfiguration(a.(*LeaderMigratorConfiguration), b.(*apiserver.LeaderMigratorConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*apiserver.LeaderMigratorConfiguration)(nil), (*LeaderMigratorConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_apiserver_LeaderMigratorConfiguration_To_v1alpha1_LeaderMigratorConfiguration(a.(*apiserver.LeaderMigratorConfiguration), b.(*LeaderMigratorConfiguration), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_ControllerLeaderConfiguration_To_apiserver_ControllerLeaderConfiguration(in *ControllerLeaderConfiguration, out *apiserver.ControllerLeaderConfiguration, s conversion.Scope) error {
	out.Name = in.Name
	out.Manager = in.Manager
	return nil
}

// Convert_v1alpha1_ControllerLeaderConfiguration_To_apiserver_ControllerLeaderConfiguration is an autogenerated conversion function.
func Convert_v1alpha1_ControllerLeaderConfiguration_To_apiserver_ControllerLeaderConfiguration(in *ControllerLeaderConfiguration, out *apiserver.ControllerLeaderConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_ControllerLeaderConfiguration_To_apiserver_ControllerLeaderConfiguration(in, out, s)
}

func autoConvert_apiserver_ControllerLeaderConfiguration_To_v1alpha1_ControllerLeaderConfiguration(in *apiserver.ControllerLeaderConfiguration, out *ControllerLeaderConfiguration, s conversion.Scope) error {
	out.Name = in.Name
	out.Manager = in.Manager
	return nil
}

// Convert_apiserver_ControllerLeaderConfiguration_To_v1alpha1_ControllerLeaderConfiguration is an autogenerated conversion function.
func Convert_apiserver_ControllerLeaderConfiguration_To_v1alpha1_ControllerLeaderConfiguration(in *apiserver.ControllerLeaderConfiguration, out *ControllerLeaderConfiguration, s conversion.Scope) error {
	return autoConvert_apiserver_ControllerLeaderConfiguration_To_v1alpha1_ControllerLeaderConfiguration(in, out, s)
}
...
func autoConvert_v1alpha1_LeaderMigratorConfiguration_To_apiserver_LeaderMigratorConfiguration(in *LeaderMigratorConfiguration, out *apiserver.LeaderMigratorConfiguration, s conversion.Scope) error {
	out.LeaderName = in.LeaderName
	out.ControllerLeaders = *(*[]apiserver.ControllerLeaderConfiguration)(unsafe.Pointer(&in.ControllerLeaders))
	return nil
}

// Convert_v1alpha1_LeaderMigratorConfiguration_To_apiserver_LeaderMigratorConfiguration is an autogenerated conversion function.
func Convert_v1alpha1_LeaderMigratorConfiguration_To_apiserver_LeaderMigratorConfiguration(in *LeaderMigratorConfiguration, out *apiserver.LeaderMigratorConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_LeaderMigratorConfiguration_To_apiserver_LeaderMigratorConfiguration(in, out, s)
}

func autoConvert_apiserver_LeaderMigratorConfiguration_To_v1alpha1_LeaderMigratorConfiguration(in *apiserver.LeaderMigratorConfiguration, out *LeaderMigratorConfiguration, s conversion.Scope) error {
	out.LeaderName = in.LeaderName
	out.ControllerLeaders = *(*[]ControllerLeaderConfiguration)(unsafe.Pointer(&in.ControllerLeaders))
	return nil
}

// Convert_apiserver_LeaderMigratorConfiguration_To_v1alpha1_LeaderMigratorConfiguration is an autogenerated conversion function.
func Convert_apiserver_LeaderMigratorConfiguration_To_v1alpha1_LeaderMigratorConfiguration(in *apiserver.LeaderMigratorConfiguration, out *LeaderMigratorConfiguration, s conversion.Scope) error {
	return autoConvert_apiserver_LeaderMigratorConfiguration_To_v1alpha1_LeaderMigratorConfiguration(in, out, s)
}
